...
angular.module("ngScreenFlow.framework").directive("breezeDataService",["eventDispatcher",function(e){return{restrict:"E",scope:{url:"@",apiPrefix:"@",entity:"@",refId:"@",canCreate:"@?",canUpdate:"@?",canDelete:"@?"},template:'<div style="display:none"></div>',link:function(t){var n=new breeze.EntityManager(t.url+""+t.apiPrefix),r=function(e){var r=(new breeze.EntityQuery).from(t.entity);if(e.toBreezeWhere){var a=e.toBreezeWhere();a&&(r=r.where(a))}if(e.toBreezeOrderBy){var i=e.toBreezeOrderBy();i&&(r=r.orderby(i))}var c=e.take;c||(c=20),r=r.take(c);var u=e.skip;return u||(u=0),r=r.skip(u),n.executeQuery(r)},a=function(e){return n.fetchEntityByKey(t.entity,e)},i=function(){n.saveChanges()},c=function(e){var r=n.createEntity(t.entity,e);n.addEntity(r),n.saveChanges()},u=function(e){e.entityAspect.setDeleted(),n.saveChanges()};e.ngOn(t,"get-items",function(e){return r(e)},t.refId),e.ngOn(t,"get-item",function(e){return a(e)},t.refId),t.canUpdate&&e.ngOn(t,"save",function(e){return i(e)},t.refId),t.canCreate&&e.ngOn(t,"create",function(e){return c(e)},t.refId),t.canDelete&&e.ngOn(t,"delete",function(e){return u(e)},t.refId)}}}]);
