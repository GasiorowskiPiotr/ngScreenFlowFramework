...
angular.module("ngScreenFlow.framework").directive("datasource",["eventDispatcher","$parse",function(e,t){return{restrict:"E",scope:!1,template:"<div></div>",link:function(n,r,i){var o=i.refId;n[o]={},e.ngOn(n,"got-items",function(e){n[o].items=e}),i.getItemsOnStart&&e.dispatch(0,"get-items",o),e.ngOn(n,"refresh",function(e){n[o].items=e},o),i.$observe("item",function(e){if(e){var r=t(e)(n);n[o].item=_.findWhere(n[o].items,r)}});var s;i.$observe("save",function(t){t?s=e.on("ref-save",function(){return e.dispatch(n[o].item,"save",o)},o):s&&s.destoy()});var a;i.$observe("createsNew",function(r){r?(n[o].item=r===!0||"true"===r?{}:t(r)(n),a=e.on("ref-create",function(){return e.dispatch(n[o].item,"create",o)},o)):(n[o].item=null,a&&a.destoy())}),n.$on("$destroy",function(){a&&a.destoy(),s&&s.destoy()})}}}]);
...
angular.module("ngScreenFlow.framework").directive("restDataService",["eventDispatcher","$q","$http",function(e,t,n){return{restrict:"E",scope:{url:"@",refId:"@",canCreate:"@?",canUpdate:"@?",canDelete:"@?",loadOnStart:"@"},template:'<div style="display:none"></div>',link:function(r){r.items=[];var a=function(){var a=t.defer();return n.get(r.url).then(function(t){r.items=t.data,e.dispatch(r.items,"refresh",r.refId),a.resolve(t.data)}).catch(function(e){a.reject(e)}),a.promise},u=function(e){return n.put(r.url+"/"+e.Id,e).then(function(){return a()})},c=function(e){return n.post(r.url,e).then(function(){return a()})},i=function(e){return n.delete(r.url+"/"+e.Id,e).then(function(){return a()})};e.ngOn(r,"load-data",function(){return a()},r.refId),e.ngOn(r,"get-items",function(){e.dispatch(r.items,"got-items")},r.refId),r.canUpdate&&e.ngOn(r,"save",function(e){return u(e)},r.refId),r.canCreate&&e.ngOn(r,"create",function(e){return c(e)},r.refId),r.canDelete&&e.ngOn(r,"delete",function(e){return i(e)},r.refId),r.loadOnStart&&a()}}}]);
...
angular.module("ngScreenFlow.framework").directive("screenFlowWrapper",function(){return{restrict:"E",scope:{item:"="},transclude:!0,template:'<div style="width: 100%"><div ng-include="item.url"></div></div>',link:function(){}}});var evilduck;!function(e){var i=function(){function e(e){var i={};e=e||{},this.options=$.extend(i,e),this.name="",this.url=""}return e}();e.ScreenFlowDefinition=i}(evilduck||(evilduck={}));
