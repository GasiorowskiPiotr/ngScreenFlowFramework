...
angular.module("ngScreenFlow.framework").directive("datasource",["eventDispatcher","$parse",function(e,t){return{restrict:"E",scope:!1,template:"<div></div>",link:function(n,i,r){var s=r.refId;n[s]={},r.getItemsOnStart&&e.dispatch({},"get-items",s).then(function(e){n[s].items=e[0].results}),r.$observe("getItem",function(i){if(i){var r=t(i)(n),o=r.Id;e.dispatch(o,"get-item",s).then(function(e){n[s].item=e[0].entity})}});var o;r.$observe("save",function(t){t?o=e.on("ref-save",function(){return e.dispatch(n[s].item,"save",s)},s):o&&o.destoy()});var a;r.$observe("createsNew",function(i){if(i){var r=n[s].item=t(i)(n);n[s].item=r.entity?e.dispatch(r.entity,"init-item",s).then(function(e){n[s].item=e}):r||{},a=e.on("ref-create",function(){return e.dispatch(n[s].item,"create",s)},s)}else n[s].item=null,a&&a.destoy()}),n.$on("$destroy",function(){a&&a.destoy(),o&&o.destoy()})}}}]);
