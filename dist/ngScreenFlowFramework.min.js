...
angular.module("ngScreenFlow.framework").directive("breezeDataService",["eventDispatcher",function(e){return{restrict:"E",scope:{url:"@",apiPrefix:"@",entity:"@",refId:"@",canCreate:"@?",canUpdate:"@?",canDelete:"@?"},template:'<div style="display:none"></div>',link:function(n){var t=new breeze.EntityManager(n.apiPrefix),r=function(e){var r=(new breeze.EntityQuery).from(n.entity),a=e.toBreezeWhere();a&&(r=r.where(a));var i=e.toBreezeOrderBy();i&&(r=r.orderby(i));var c=e.take;0===c&&(c=20),r=r.take(c);var u=e.skip;return r=r.skip(u),t.executeQuery(r)},a=function(e){return t.fetchEntityByKey(n.entity,e)},i=function(){t.saveChanges()},c=function(e){var r=t.createEntity(n.entity,e);t.addEntity(r),t.saveChanges()},u=function(e){e.entityAspect.setDeleted(),t.saveChanges()};e.ngOn(n,"get-items",function(e){return r(e)},n.refId),e.ngOn(n,"get-item",function(e){return a(e)},n.refId),n.canUpdate&&e.ngOn(n,"save",function(e){return i(e)},n.refId),n.canCreate&&e.ngOn(n,"create",function(e){return c(e)},n.refId),n.canDelete&&e.ngOn(n,"delete",function(e){return u(e)},n.refId)}}}]);
