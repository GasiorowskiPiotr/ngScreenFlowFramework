...
angular.module("ngScreenFlow.framework").directive("breezeDataService",["eventDispatcher",function(e){return{restrict:"E",scope:{url:"@",apiPrefix:"@",entity:"@",entities:"@",refId:"@",canCreate:"@?",canUpdate:"@?",canDelete:"@?"},template:'<div style="display:none"></div>',link:function(t){var n=new breeze.EntityManager(t.url+""+t.apiPrefix),r=function(e){var r=(new breeze.EntityQuery).from(t.entities);if(e.toBreezeWhere){var i=e.toBreezeWhere();i&&(r=r.where(i))}if(e.toBreezeOrderBy){var a=e.toBreezeOrderBy();a&&(r=r.orderby(a))}var u=e.take;u||(u=20),r=r.take(u);var c=e.skip;return c||(c=0),r=r.skip(c).inlineCount(),n.executeQuery(r)},i=function(e){return n.fetchEntityByKey(t.entity,e)},a=function(){return n.saveChanges()},u=function(e){var r=n.createEntity(t.entity,e);return n.addEntity(r),n.saveChanges()},c=function(e){return i(e).then(function(e){return e.entity.entityAspect.setDeleted(),n.saveChanges()})};e.ngOn(t,"get-items",function(e){return r(e)},t.refId),e.ngOn(t,"get-item",function(e){return i(e)},t.refId),t.canUpdate&&e.ngOn(t,"save",function(e){return a(e)},t.refId),t.canCreate&&(e.ngOn(t,"create",function(e){return u(e)},t.refId),e.ngOn(t,"init-item",function(e){return n.createEntity(e)})),t.canDelete&&e.ngOn(t,"delete",function(e){return c(e)},t.refId)}}}]);
...
angular.module("ngScreenFlow.framework").directive("datasource",["eventDispatcher","$parse",function(t,e){return{restrict:"E",scope:!1,template:"<div></div>",link:function(n,i,r){var s=r.refId;n[s]={},t.ngOn(n,"reload",function(){if(t.dispatch({},"get-items",s).then(function(t){n[s].items=t[0].results}),r.getItem){var i=e(r.getItem)(n),o=i.Id;t.dispatch(o,"get-item",s).then(function(t){n[s].item=t[0].entity})}},s),r.getItemsOnStart&&t.dispatch({},"get-items",s).then(function(t){n[s].items=t[0].results}),r.$observe("getItem",function(i){if(i){var r=e(i)(n),o=r.Id;t.dispatch(o,"get-item",s).then(function(t){n[s].item=t[0].entity})}});var o;r.$observe("save",function(e){e?o=t.on("ref-save",function(){return t.dispatch(n[s].item,"save",s)},s):o&&o.destoy()});var c;r.$observe("createsNew",function(i){if(i){var r=n[s].item=e(i)(n);n[s].item=r.entity?t.dispatch(r.entity,"init-item",s).then(function(t){n[s].item=t}):r||{},c=t.on("ref-create",function(){return t.dispatch(n[s].item,"create",s)},s)}else n[s].item=null,c&&c.destoy()}),n.$on("$destroy",function(){c&&c.destoy(),o&&o.destoy()})}}}]);
angular.module("ngScreenFlow.framework").directive("deletesItem",["eventDispatcher","$parse",function(e,t){return{restrict:"A",scope:!1,link:function(n,c,a){var r=t(a.deletesItem)(n),i=r.on,s=r.id;c.click(function(){n.$apply(function(){var t=e.dispatch(s,"delete",i);if(a.changeStateOnSuccessTo){var n=$iAttrs.changeStateOnSuccessTo;t.then(function(){return e.dispatch({next:n},"state-changed")})}})})}}}]);
...
angular.module("ngScreenFlow.framework").directive("reload",["eventDispatcher",function(e){return{restrict:"A",scope:!1,link:function(n,r,c){var i=c.reload;r.click(function(){n.$apply(function(){e.dispatch(0,"reload",i)})})}}}]);
...
angular.module("ngScreenFlow.framework").directive("validatorMessage",function(){return{restrict:"E",scope:!1,transclude:!0,replace:!0,template:'<small class="error" ng-transclude></small>',link:function(r,e,t){var a=t.form,l=t.field,n=t.error;r.$watch(a+"."+l+".$error."+n,function(t){t&&(r[a].$submitted||r[a].$touched||r[a].$dirty)?e.show():e.hide()})}}});